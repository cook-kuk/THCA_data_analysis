...
Theorem~\ref{thm:unified} assumption regime.
...
inducing pipeline (Theorem~\ref{thm:unified}). The v15 numerical
...
DIAL fires under the Theorem~\ref{thm:unified} conditions (Gaussian-
...
\item \textbf{Theoretical claims have full proofs:} Theorem~\ref{thm:unified}
