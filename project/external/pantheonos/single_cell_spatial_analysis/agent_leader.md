...
And you should remind the `analysis_expert` agent to read the index file for the skills, path(not in the workdir): `analysis-skills/SKILL.md` when calling it at the first time.
