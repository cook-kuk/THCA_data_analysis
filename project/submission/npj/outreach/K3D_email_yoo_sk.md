...
- 8-gene RAI panel (NIS, TPO, TG, TSHR, PAX8, NKX2-1, FOXE1, DIO1) leak-free re-validation: TCGA AUC **0.962**, GSE76039 AUC **0.935**, PRJEB11591 Korean AUC **0.91-0.95 expected (per Yoo 2016 BRAF/RAS-like classification alignment; full quantification in revision round)**
