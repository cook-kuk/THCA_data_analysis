#!/usr/bin/env python3
"""Validate CROSS-Neo impact frontier v15 outputs."""
...
BASE = ROOT / "project/results/cross_neo_kaggle_winner_playbook_2026_05_10/impact_frontier_v15_2026_05_11"
HUB = ROOT / "project/papers_hub_2026_05_04"
ASSETS = HUB / "assets/cross_neo_impact_frontier_v15"
HTML = HUB / "cross_neo_impact_frontier_v15.html"


def main() -> None:
    summary = json.loads((BASE / "impact_frontier_v15_summary.json").read_text())
    ...
    checks = {
        "figure_caption_pack_v15.tsv": 8,
        "reviewer_summary_v15.tsv": 8,
        "decision_ladder_v15.tsv": 6,
        "one_screen_board_v15.tsv": 7,
    }
