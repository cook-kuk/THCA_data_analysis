...
def main() -> None:
    ...
    steps = [
        ...
        "build_public_overlap_audit_intake_pack.py",
        ...
        "analyze_source_hla_stress.py",
        "build_barneo_stress_guarded_ranker.py",
        "build_barneo_high_impact_pack.py",
        "build_barneo_reviewer_kill_audit.py",
        "build_barneo_top_pass_evidence_pack.py",
        "build_barneo_t1_translational_readiness_pack.py",
        "build_barneo_t1_impact_upgrade_pack.py",
        "build_barneo_ng_algorithm.py",
        "build_ga_rl_barneo_bridge.py",
        "build_ga_rl_patient_gate_pack.py",
        "build_ga_rl_failure_heatmap_pack.py",
        "build_ga_rl_failure_atlas_pack.py",
        "build_ga_rl_rescue_quadrant_pack.py",
        "build_ga_rl_rescue_evidence_pack.py",
        "build_mhc_ii_separate_benchmark_pack.py",
        "build_barneo_nature_grade_evolution_pack.py",
