#!/usr/bin/env python3
"""Validate CROSS-Neo impact frontdoor v19 outputs."""
...
BASE = ROOT / "project/results/cross_neo_kaggle_winner_playbook_2026_05_10/impact_frontdoor_v19_2026_05_11"
HUB = ROOT / "project/papers_hub_2026_05_04"
ASSETS = HUB / "assets/cross_neo_impact_frontdoor_v19"
HTML = HUB / "cross_neo_impact_frontdoor_v19.html"


def main() -> None:
    summary = json.loads((BASE / "impact_frontdoor_v19_summary.json").read_text())
    ...
    checks = {
        "headline_strip_v19.tsv": 6,
        "verdict_matrix_v19.tsv": 6,
        "risk_triage_v19.tsv": 8,
        "action_queue_v19.tsv": 6,
        "evidence_spine_v19.tsv": 6,
    }
